  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      creatures.forEach((creature) => {
        ...
        // Вычисляем точные иерархические сгибы всех шарниров и плеч чудика
        const bentMap = calculateKinematicBends(creature.elements, creature.muscleStep, creature.forces);
